    ...
    return (
        <section className=' py-5 position-relative'>
            ...
            <Container>
                    ...
                    <Col xs={12} xl={8}>
                        <Row>
                            <Col xs={12} sm={6} xxl={4}>
                                <div className=' d-flex justify-content-xl-center quick_link position-relative'>
                                    <ul className=' list-unstyled  '>
                                        <li className=' ff_Anybody fw_700 fs_lg darkgreen'>Quick link</li>
                                        <li><a className=' ff_Red_Hat fw_400 fs_sm grey90 d-inline-block pt-3 pt-md-4 pt-lg-5' href="#">Tracking</a></li>
                            ...
                            <Col xs={12} sm={6} xxl={4}>
                                <div className=' d-flex justify-content-xl-center quick_border position-relative'>
                                    <ul className=' list-unstyled'>
                                        <li className=' ff_Anybody fw_700 fs_lg darkgreen'>Contact us</li>
                                        <div className=' d-flex mt-3 mt-md-4 mt-lg-5 mt-lg-2'>
                                        ...
                                        <div className=' d-flex pt-2 pt-lg-4'>
                                        ...
                                        <div className=' d-flex pt-2 pt-lg-4'>
                                            ...
                                            <li><a className=' ff_Red_Hat fw_400 fs_sm grey90 ps-3' href="#">2715 Ash Dr. San Jose, South </a></li>
                                        </div>
                                        <li><a className=' ff_Red_Hat fw_400 fs_sm grey90 ps-4' href="#">Dakota 83475</a></li>

                                    </ul>
                                </div>
                            </Col>
                            <Col xs={12} sm={6} xxl={4}>
                                <div className=' d-flex justify-content-xxl-center ps-xxl-4 pt-4 pt-xl-0'>
                                    <ul className='list-unstyled'>
                                        <li className=' ff_Anybody fw_700 fs_lg darkgreen'>Subscribe</li>
                                        <input className=' input_txt mt-3 mt-md-4 mt-lg-5' type="text" placeholder='Name' /> <br />
                                        <input className=' mt-4 input_txt mt-4' type="text" placeholder='Email' />
                                        <div className='pt-3 pt-md-5 mt-xl-5'>
                                            <Btn_green any_text='Subscribe' />
                                        </div>
                                    </ul>
                                </div>
                            </Col>
                ...
                <div className='footer_border mt-3'></div>
                <div className=' d-flex flex-column flex-lg-row justify-content-between pt-5'>
                    <p className=' ff_Red_Hat fw_400 fs_lg grey90'>Copyright 2023 | Uitaskca - All rights Reserved</p>
                    <div className=' pb-3'>
                        <span className=' pe-5'><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className=' pe-5'><svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
